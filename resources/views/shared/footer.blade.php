        ...
        <div class="flex flex-wrap lg:flex-nowrap items-center">
            <div class="footer-logo order-0 basis-full sm:basis-1/2 lg:basis-1/3 shrink-0 text-center sm:text-left">
                <a href="{{ route('home') }}" class="inline-block" rel="home">
                    <img src="{{ Vite::image('laravel-logo.svg') }}" class="w-[155px] h-[38px]">
                </a>
            </div><!-- /.footer-logo -->
            <div class="footer-copyright order-2 lg:order-1 basis-full lg:basis-1/3 mt-8 lg:mt-0">
                <div class="text-[#999] text-xxs xs:text-xs sm:text-sm text-center">Laravel, 2022 ©</div>
        ...
        <div class="mmenu-heading flex items-center pt-6 xl:pt-12">
            <div class="shrink-0 grow">
                <a href="{{ route('home') }}" rel="home">
                    <img src="{{ Vite::image('laravel-logo.svg') }}" class="w-[148px] md:w-[201px] h-[36px] md:h-[50px]" >
                </a>
            </div>
        ...
        <div class="mmenu-inner pt-10">
            @auth
                <div class="flex items-center">
                        <img src="{{ auth()->user()->avatar }}" class="w-14 h-14 rounded-full" >
                        <div class="flex flex-col items-start ml-4">
                            ...
                            <a href="#" class="inline-flex items-center text-dark hover:text-pink">
                                ...
                                <span class="ml-[6px] font-medium">Logout</span>
                            </a>
                        </div>
                    </div>
            @elseguest
                <a href="{{ route('loginPage') }}" class="profile flex items-center mr-12">
                        ...
                        <span class="profile-text relative ml-2 text-dark font-bold">Login</span>
                    </a>
            @endauth

            <nav class="flex flex-col mt-8">
                <a href="{{ route('home') }}" class="self-start py-1 text-dark hover:text-pink text-md font-bold">Home</a>
                <a href="#" class="self-start py-1 text-dark hover:text-pink text-md font-bold">Products</a>
                <a href="#" class="self-start py-1 text-dark hover:text-pink text-md font-bold">My orders</a>
                <a href="#" class="self-start py-1 text-dark hover:text-pink text-md font-bold">Cart</a>
            </nav>

        ...
        <div class="header-inner flex items-center justify-between lg:justify-start">
            <div class="header-logo shrink-0">
                <a href="{{ route('home') }}" rel="home">
                    <img src="{{ Vite::image('laravel-logo.svg') }}" class="w-[120px] xs:w-[148px] md:w-[201px] h-[30px] xs:h-[36px] md:h-[50px]" alt="CutCode">
                </a>
            </div><!-- /.header-logo -->
            <div class="header-menu grow hidden lg:flex items-center ml-8 mr-8 gap-8">
                ...
                <nav class="hidden 2xl:flex gap-8">
                    ...
                    <a href="#" class="text-white hover:text-pink font-bold">Products</a>
            ...
            <div class="header-actions flex items-center gap-3 md:gap-5">
                ...
                @elseguest
                    <a href="{{ route('loginPage') }}" class="profile hidden xs:flex items-center">
                        ...
                        <span class="profile-text relative ml-2 text-white text-xxs md:text-xs font-bold">Login</span>
                    </a>
                @endauth
                ...
                <a href="#" class="flex items-center gap-3 text-pink hover:text-white">
                    ...
                    <div class="hidden sm:flex flex-col gap-2">
                        <span class="text-body text-xxs leading-none">3 </span>
                        <span class="text-white text-xxs 2xl:text-xs font-bold !leading-none">900 $</span>
                    </div>
                </a>

...
@section('content')
    ...
    >
        ...
        <x-forms.primary-button>Registration</x-forms.primary-button>
        ...
        <x-slot:buttons>
            <div class="space-y-3 mt-5">
                <div class="text-xxs md:text-xs">
                    <a href="{{ route('loginPage') }}" class="text-white hover:text-white/70 font-bold">Login</a>
                </div>
            </div>
        </x-slot:buttons>
